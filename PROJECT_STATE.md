...
## Checkpoint V — BT-014 Part A (shared-expenses-aware deletion, CSV/JSON export) and BT-014-04 (full frontend UI) (2026-09-17)
...
- **XLSX/PDF export formats** — see Part A above (BT-014-05).
...
- Decide the XLSX/PDF dependency question (BT-014-05) — recommended but not added unilaterally.
