...
- **In progress:** independent security and financial reviews of `39ed5e0..f3ce009`; dropdown conversion (picker step 2) by an implementation agent in a worktree on `feature/picker-dropdowns` (shared adapter first, one view per commit, Shared expenses last).
