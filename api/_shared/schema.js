...
const CURRENT = Object.freeze({ workspace: 1, user: 1, site: 1, backup: 1, usage: 1, gallery: 1 });
...
const MIGRATIONS = Object.freeze({ workspace: {}, user: {}, site: {}, backup: {}, usage: {}, gallery: {} });
