...
const SCENARIOS = [privacy, shared, concurrency, guards, dropdown, staging, recheck, settings, accounts, bills, remove, deleteworkspace, move, analytics, login, gallery, permanentdelete, dashboard, accountrequests, transactions, overlay, quota, actionsmenu, mysettings, workspacecolours, addbillfromentry, addperson, contactjoins, groupcurrency, groupevents, groupsplits, groupunits, grouprefunds, groupitemized, groupfund, groupinsights, grouprequests, groupsplitwise, groupoffline, accounttypes, debtpayments, categorymerchanttypes, acruoverview, finexabudget, ledgerflyforecast, gallerybatch2, gallerybatch3, gallerysummaries, gallerysettings, gallerycog, ledgerflypages, finexapages, acrupages, flagshipcolors, flagshipsettings, layoutpicker, dashboardflagship, layoutpreview, transactionsflagship];
