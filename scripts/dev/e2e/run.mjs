...
import * as groupcurrency from "./groupcurrency.mjs";
import * as groupevents from "./groupevents.mjs";
import * as groupsplits from "./groupsplits.mjs";
import * as groupunits from "./groupunits.mjs";
import * as grouprefunds from "./grouprefunds.mjs";
import * as groupitemized from "./groupitemized.mjs";
import * as groupfund from "./groupfund.mjs";
import * as groupinsights from "./groupinsights.mjs";
import * as grouprequests from "./grouprequests.mjs";
import * as groupsplitwise from "./groupsplitwise.mjs";
import * as groupoffline from "./groupoffline.mjs";
import * as accounttypes from "./accounttypes.mjs";
import * as debtpayments from "./debtpayments.mjs";
import * as categorymerchanttypes from "./categorymerchanttypes.mjs";
import * as acruoverview from "./acruoverview.mjs";
import * as finexabudget from "./finexabudget.mjs";
import * as ledgerflyforecast from "./ledgerflyforecast.mjs";
import * as gallerybatch2 from "./gallerybatch2.mjs";
import * as gallerybatch3 from "./gallerybatch3.mjs";
import * as gallerysummaries from "./gallerysummaries.mjs";
import * as gallerysettings from "./gallerysettings.mjs";
import * as gallerycog from "./gallerycog.mjs";
import * as ledgerflypages from "./ledgerflypages.mjs";
import * as finexapages from "./finexapages.mjs";
import * as acrupages from "./acrupages.mjs";
import * as flagshipcolors from "./flagshipcolors.mjs";
import * as flagshipsettings from "./flagshipsettings.mjs";
import * as layoutpicker from "./layoutpicker.mjs";
import * as dashboardflagship from "./dashboardflagship.mjs";
import * as layoutpreview from "./layoutpreview.mjs";
import * as transactionsflagship from "./transactionsflagship.mjs";
import * as billsflagship from "./billsflagship.mjs";
import * as planningflagship from "./planningflagship.mjs";
import * as accountsflagship from "./accountsflagship.mjs";
import * as merchantsflagship from "./merchantsflagship.mjs";
import * as groupflagship from "./groupflagship.mjs";
import * as settingsflagship from "./settingsflagship.mjs";
import * as workspaceflagship from "./workspaceflagship.mjs";
import * as layoutcrosscutting from "./layoutcrosscutting.mjs";

const SCENARIOS = [privacy, shared, concurrency, guards, dropdown, staging, recheck, settings, accounts, bills, remove, deleteworkspace, move, analytics, login, gallery, permanentdelete, dashboard, accountrequests, transactions, overlay, quota, actionsmenu, mysettings, categories, addbillfromentry, addperson, contactjoins, groupcurrency, groupevents, groupsplits, groupunits, grouprefunds, groupitemized, groupfund, groupinsights, grouprequests, groupsplitwise, groupoffline, accounttypes, debtpayments, categorymerchanttypes, acruoverview, finexabudget, ledgerflyforecast, gallerybatch2, gallerybatch3, gallerysummaries, gallerysettings, gallerycog, ledgerflypages, finexapages, acrupages, flagshipcolors, flagshipsettings, layoutpicker, dashboardflagship, layoutpreview, transactionsflagship, billsflagship, planningflagship, accountsflagship, merchantsflagship, groupflagship, settingsflagship, workspaceflagship, layoutcrosscutting];
const ALIASES = { group: "shared", "shared-expenses": "shared", picker: "dropdown", dropdowns: "dropdown", "route-guards": "guards", "staging-link": "staging", "workspace-settings": "settings", "edit-account": "accounts", "remove-account": "remove", "delete-workspace": "deleteworkspace", archive: "deleteworkspace", "move-entry": "move", "move-account": "move", usage: "analytics", "site-usage": "analytics", "sign-in": "login", landing: "login", "design-gallery": "gallery", layouts: "gallery", "permanent-delete": "permanentdelete", "bt-014": "permanentdelete", "record-deletion": "permanentdelete", tooltip: "bills", "record-next": "bills", "spending-by-category": "dashboard", "top-merchants": "dashboard", "this-week": "dashboard", "account-requests": "accountrequests", "bt-014-17": "accountrequests", "quick-entry": "transactions", "add-expense": "transactions", "new-merchant": "transactions", "no-reflow": "overlay", "icon-picker": "overlay", "theme-picker": "overlay", "colour-palette": "overlay", "workspace-rate": "quota", "workspace-quota": "quota", "rate-limit": "quota", "record-actions": "actionsmenu", "bt-015": "actionsmenu", "action-menu": "actionsmenu", "compact-actions": "actionsmenu", "my-settings": "mysettings", "bt-017": "mysettings", "settings-redesign": "mysettings", "add-as-bill": "addbillfromentry", "bill-from-entry": "addbillfromentry", "bill-from-transaction": "addbillfromentry", "add-a-person": "addperson", "bt-016": "addperson", "contact-joins": "contactjoins", "bt-009-15": "contactjoins", "multi-currency": "groupcurrency", "foreign-currency": "groupcurrency", "bt-009-13": "groupcurrency", "events": "groupevents", "event-directory": "groupevents", "bt-009-20": "groupevents", "bt-009-21": "groupevents", "fixed-remainder": "groupsplits", "split-presets": "groupsplits", "bt-009-25": "groupsplits", "settlement-units": "groupunits", households: "groupunits", "couples-families": "groupunits", refunds: "grouprefunds", "linked-refunds": "grouprefunds", itemized: "groupitemized", "itemized-receipts": "groupitemized", fund: "groupfund", contributions: "groupfund", deposits: "groupfund", insights: "groupinsights", reminders: "grouprequests", "payment-requests": "grouprequests", "payment-reminders": "grouprequests", "bt-009-26": "grouprequests",
  ...
  "workspace-colours": "categories", "category-colours": "categories", "bt-019-04": "categories", "bt-022": "categories", "web-development": "categories",
  "account-types": "accounttypes", "bt-019-02": "accounttypes",
  "debt-payments": "debtpayments", "debt-payment": "debtpayments", "bt-020": "debtpayments",
  "category-merchant-types": "categorymerchanttypes", "bt-019-01": "categorymerchanttypes", "bt-019-03": "categorymerchanttypes",
  "acru-overview": "acruoverview", "bt-013-10": "acruoverview", "acru": "acruoverview",
  "finexa-budget": "finexabudget", "finexa": "finexabudget",
  "ledgerfly-forecast": "ledgerflyforecast", "ledgerfly": "ledgerflyforecast",
  "bt-013-11": "gallerybatch2", batch2: "gallerybatch2", "spend-radar": "gallerybatch2", "family-circle": "gallerybatch2", "milestone-path": "gallerybatch2",
  "bt-013-12": "gallerybatch3", batch3: "gallerybatch3",
  "bt-013-13": "gallerysummaries", summaries: "gallerysummaries",
  "bt-013-14": "gallerysettings", "my-settings-gallery": "gallerysettings", "workspace-settings-gallery": "gallerysettings",
  "bt-013-15": "gallerycog", "appearance-cog": "gallerycog", "gallery-colours": "gallerycog", "full-size-preview": "gallerycog",
  "ledgerfly-pages": "ledgerflypages", "executive-forecast-pages": "ledgerflypages",
  "finexa-pages": "finexapages", "budget-workspace-pages": "finexapages",
  "acru-pages": "acrupages", "financial-overview-pages": "acrupages",
  "flagship-colors": "flagshipcolors", "flagship-colours": "flagshipcolors", "colour-schemes": "flagshipcolors",
  "flagship-settings": "flagshipsettings" };
