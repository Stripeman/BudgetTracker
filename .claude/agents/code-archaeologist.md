...
description: Discover canonical code paths before potential TaskTracker reuse.
...
Claude Code: this file is generated by scripts/setup-project-agents.py from the same reviewed text as .codex/agents/code-archaeologist.toml. Edit the generator, not this file. Invoke through the Agent tool with this agent's name. Read-only: Bash is for inspection, tests and scratch probes outside the repository only.
